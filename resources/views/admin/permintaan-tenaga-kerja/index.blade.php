...
<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
    <h2 class="m-0 font-weight-bold text-primary">Permintaan Tenaga Kerja</h2>
    <a href="{{ route('permintaan-tenaga-kerja.create') }}" class="btn btn-primary btn-sm btn-icon-split">
