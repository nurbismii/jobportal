...
<head>
    ...
    <style>
        ...
        .panel.is-locked{background:#dce3eb;border:1px solid #aebdcd;box-shadow:inset 0 4px 0 #6c8096}
        .panel.is-locked h2{color:#293b50}
        .panel.is-locked [data-stage-status]{display:inline-flex;align-items:center;gap:8px;background:#40556c;color:#fff;border-radius:6px;padding:7px 12px;font-size:13px;font-weight:700;margin-top:0}
        .panel.is-locked .muted,.panel.is-locked .drop-hint,.panel.is-locked .file-selection{color:#40556c}
        .panel.is-locked .drop-zone{background:#cbd5e1;border-color:#91a3b7;color:#40556c;cursor:not-allowed}
        .panel.is-locked .drop-zone svg{color:#52677f}
        .panel.is-locked button:disabled{background:#738398;color:#fff;opacity:1;cursor:not-allowed}
...
<body><main>
    ...
    <div class="forms">
        ...
        @endphp
        <section class="panel {{ $locked ? 'is-locked' : '' }}" data-category="{{ $category }}">
